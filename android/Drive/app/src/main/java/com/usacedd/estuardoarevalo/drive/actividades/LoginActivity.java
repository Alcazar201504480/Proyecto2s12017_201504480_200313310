...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Call<IniciarSesionResponse> call = mDjangoApi.iniciarSesion(email, password);
            call.enqueue(new Callback<IniciarSesionResponse>() {
                ...
                public void onResponse(Call<IniciarSesionResponse> call, Response<IniciarSesionResponse> response) {
                    ...
                    IniciarSesionResponse rsp = response.body();

                    if (rsp.error == null){

                        //guardar la sesion del usuario y luego lanzar la actividad de inicio
                        SesionUsuario sesionUsuario = new SesionUsuario();
                        sesionUsuario.usuario = rsp.usuario;
                        sesionUsuario.apellido = rsp.nombre;
                        sesionUsuario.nombre = rsp.apellido;
                        sesionUsuario.password = rsp.password;
                        sesionUsuario.nacimiento = rsp.nacimiento;
                        ...
                        mPasswordView.setError(rsp.error);
    ...
    private boolean isPasswordValid(String password) {
        //con que haya escrito algo es suficiente
